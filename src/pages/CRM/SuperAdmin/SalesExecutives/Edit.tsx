...
export default function EditSalesExecutivePage() {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-4 mb-6">
        <Button variant="ghost" size="sm" onClick={() => navigate("/crm/superadmin/sales-executives")} className="gap-2">
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
            ...
            <div className="flex gap-3 justify-end">
              <Button type="button" variant="outline" onClick={() => navigate("/crm/superadmin/sales-executives")} disabled={saving} className="h-11 w-full sm:w-auto">Cancel</Button>
