...
export default function SMSalesExecutivesPage() {
    ...
    <div className="p-6">
      <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <Link to="/crm/sales-manager/sales-executives/add">
            ...
            {loading ? (
              ...
              filteredExecutives.map((executive) => (
                <TableRow key={executive._id}>
                  ...
                  <TableCell>{new Date(executive.createdAt).toLocaleDateString()}</TableCell>
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => navigate(`/crm/sales-manager/sales-executives/${executive._id}/edit`)}
                      >
